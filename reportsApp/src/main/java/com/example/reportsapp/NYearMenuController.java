...
public class NYearMenuController {
    @FXML
    ...
    public void getData(){
        ...
        if (rokPocz.isEmpty() || rokKon.isEmpty()){
            ...
            try{
                ...
                String reportPath = "C:\\Users\\sarar\\IdeaProjects\\reportsApp\\reportsCompiled\\RaportNabycia.jasper";
                Map<String, Object> parameters = new HashMap<>();

                parameters.put("RokPocz", paramRokPocz);
                parameters.put("RokKon", paramRokKon);
